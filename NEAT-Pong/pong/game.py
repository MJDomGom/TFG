...
class Game:
    ...
    def _draw_score(self):
        ...
        #left_score_text = self.crearFuente(str(self.left_score))
        #right_score_text = self.crearFuente(str(self.left_score))
    ...
    def _draw_hits(self):
        hits_text = self.SCORE_FONT.render(
            str(self.left_hits + self.right_hits), True, self.RED)
